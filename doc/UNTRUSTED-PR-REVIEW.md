...
This is intentionally separate from the normal MSProLtd dev image.
...
```sh
review-checkout-pr msproltdai/mspro-ltd 432
cd /work/checkouts/msproltdai-mspro-ltd/pr-432
```
...
## Preview the MSProLtd app from the PR
...
- MSProLtd's embedded PostgreSQL and local storage stay inside the container home volume via `MSPROLTD_HOME=/home/reviewer/.mspro-ltd-review`.
