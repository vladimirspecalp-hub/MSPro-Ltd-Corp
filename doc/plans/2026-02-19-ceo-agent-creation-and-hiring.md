...
- installed adapter list for this MSProLtd instance
...
## 8. New Skill: `mspro-ltd-create-agent`

Create new skill directory:

- `skills/mspro-ltd-create-agent/SKILL.md`
...
Also update `skills/mspro-ltd/SKILL.md` to reference this skill for hiring workflows.
...
- `mspro-ltd-create-agent` skill + docs updates
