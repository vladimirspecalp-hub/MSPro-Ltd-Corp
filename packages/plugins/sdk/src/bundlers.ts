/**
 * Bundling presets for MSProLtd plugins.
 *
 ...
 * to match the MSProLtd plugin loader contract.
 */
export function createPluginBundlerPresets(input: PluginBundlerPresetInput = {}): PluginBundlerPresets {
  const uiExternal = [
    "@msproltd/plugin-sdk/ui",
    "@msproltd/plugin-sdk/ui/hooks",
    "react",
    "react-dom",
    "react/jsx-runtime",
  ];
