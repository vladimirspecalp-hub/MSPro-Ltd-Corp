/**
 * `@msproltd/plugin-sdk/ui` — MSProLtd plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@msproltd/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@msproltd/plugin-sdk/ui";
 *
