...
const manifest: PaperclipPluginManifestV1 = {
  ...
  description: "Reference plugin that demonstrates the current MSProLtd plugin API surface, UI surfaces, bridge actions, events, jobs, webhooks, tools, local workspace access, and runtime diagnostics in one place.",
  author: "MSProLtd",
  ...
  tools: [
    ...
    },
    {
      ...
      description: "Summarizes the current company using the MSProLtd domain APIs.",
      parametersSchema: {
        type: "object",
        properties: {},
      },
