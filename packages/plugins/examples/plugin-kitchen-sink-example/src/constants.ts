import type { PluginLauncherRegistration } from "@msproltd/plugin-sdk";

export const PLUGIN_ID = "mspro-ltd-kitchen-sink-example";
...
export const DEFAULT_CONFIG = {
  ...
  workspaceScratchFile: ".mspro-ltd-kitchen-sink-demo.txt",
} as const;
