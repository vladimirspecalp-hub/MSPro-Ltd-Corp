...
description: >
  Generate the stable MSProLtd release changelog at releases/vYYYY.MDD.P.md by
  reading commits, changesets, and merged PR context since the last stable tag.
---

# Release Changelog Skill

Generate the user-facing changelog for the **stable** MSProLtd release.

## Versioning Model

MSProLtd uses **calendar versioning (calver)**:
...
```
- **Feature name** — Description. ([#123](https://github.com/vladimirspecalp-hub/mspro-ltd/pull/123), @contributor1, @contributor2)
```
