...
name: release
description: >
  Coordinate a full MSProLtd release across engineering verification, npm,
...
Run the full MSProLtd maintainer release workflow, not just an npm publish.
...
7. If running through MSProLtd, you have issue context for status updates and follow-up task creation.
...
MSProLtd now uses a commit-driven release model:
...
npm view msproltdai@canary version
```
...
- release summary in MSProLtd issue context
