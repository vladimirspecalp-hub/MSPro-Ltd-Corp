 ...
 *
 * Plugin bundles are built with `external: ["@msproltd/plugin-sdk/ui", "react", "react-dom"]`,
 ...
 * - `import { ... } from "@msproltd/plugin-sdk/ui";`
 *
...
function rewriteBareSpecifiers(source: string): string {
  ...
  const rewrites: Record<string, string> = {
    '"@msproltd/plugin-sdk/ui"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@msproltd/plugin-sdk/ui'": `'${getShimBlobUrl("sdk-ui")}'`,
    '"@msproltd/plugin-sdk/ui/hooks"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@msproltd/plugin-sdk/ui/hooks'": `'${getShimBlobUrl("sdk-ui")}'`,
 ...
 * of `@msproltd/plugin-sdk/ui`, `react`, and `react-dom` resolve to the
