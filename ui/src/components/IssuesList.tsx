  ...
  return (
    <div className="relative w-48 sm:w-64 md:w-80">
      ...
      <Input
        ...
        aria-label={t("issues.search_aria")}
...
export function IssuesList({
      ...
      label:
        key === "__unassigned"
          ...
          : key.startsWith("__user:")
            ? (formatAssigneeUserLabel(key.slice("__user:".length), currentUserId) ?? t("issues.user_fallback"))
  ...
  const createActionLabel = createIssueLabel
    ? t("issues.create_action_named", { label: createIssueLabel })
    : t("issues.create_action");
  const createButtonLabel = createIssueLabel
    ? t("issues.new_named", { label: createIssueLabel })
    : t("issues.new");
    ...
    <div className="space-y-4">
        ...
        <div className="flex items-center gap-0.5 sm:gap-1 shrink-0">
          ...
          <div className="flex items-center border border-border rounded-md overflow-hidden mr-1">
            <button
              ...
              title={t("issues.view_list_title")}
            >
            ...
            <button
              ...
              title={t("issues.view_board_title")}
            >
          ...
          {viewState.viewMode === "list" && (
            <Button
              ...
              title={viewState.nestingEnabled ? t("issues.nesting_disable") : t("issues.nesting_enable")}
            >
          ...
          {viewState.viewMode === "list" && (
            <Popover>
              <PopoverTrigger asChild>
                <Button variant="outline" size="icon" className="h-8 w-8 shrink-0" title={t("issues.sort_title")}>
              ...
              <PopoverContent align="end" className="w-48 p-0">
                <div className="p-2 space-y-0.5">
                  {([
                    ["status", t("issues.sort_status")],
                    ["priority", t("issues.sort_priority")],
                    ["title", t("issues.sort_title_field")],
                    ["created", t("issues.sort_created")],
                    ["updated", t("issues.sort_updated")],
          ...
          {viewState.viewMode === "list" && (
            <Popover>
              <PopoverTrigger asChild>
                <Button variant="outline" size="icon" className="h-8 w-8 shrink-0" title={t("issues.group_title")}>
              ...
              <PopoverContent align="end" className="w-44 p-0">
                <div className="p-2 space-y-0.5">
                  {([
                    ["status", t("issues.group_status")],
                    ["priority", t("issues.group_priority")],
                    ["assignee", t("issues.group_assignee")],
                    ["workspace", t("issues.group_workspace")],
                    ["parent", t("issues.group_parent")],
                    ["none", t("issues.group_none")],
      ...
      {normalizedIssueSearch.length > 0 && searchedIssues.length === ISSUE_SEARCH_RESULT_LIMIT && (
        <p className="text-xs text-muted-foreground">
          {t("issues.search_limit_notice", { limit: ISSUE_SEARCH_RESULT_LIMIT })}
        </p>
      )}
                      ...
                      <IssueRow
                        ...
                        titleSuffix={hasChildren && !isExpanded ? (
                          <span className="ml-1.5 text-xs text-muted-foreground">
                            ({t("issues.subtasks_count", { count: totalDescendants })})
                          </span>
                        ) : undefined}
                        mobileLeading={
                          hasChildren ? (
                                ...
                                >
                                    ...
                                    >
                                      {issue.assigneeAgentId && agentName(issue.assigneeAgentId) ? (
                                        ...
                                        <span className="inline-flex items-center gap-1.5 text-xs">
                                          ...
                                          {formatAssigneeUserLabel(issue.assigneeUserId, currentUserId) ?? t("issues.user_fallback")}
                                        </span>
                                      ) : (
                                  ...
                                  >
                                    <input
                                      ...
                                      placeholder={t("issues.search_assignees_placeholder")}
