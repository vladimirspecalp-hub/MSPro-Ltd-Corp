...
import { buildAgentMentionHref, buildProjectMentionHref } from "@msproltd/shared";
  ...
  if (richEditorError) {
    return (
      <div
        ref={containerRef}
        className={cn(
          "relative mspro-ltd-mdxeditor-scope",
  ...
  return (
    ...
    >
      <MDXEditor
        ...
        className={cn("mspro-ltd-mdxeditor", !bordered && "mspro-ltd-mdxeditor--borderless")}
        contentEditableClassName={cn(
          "mspro-ltd-mdxeditor-content focus:outline-none [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_li]:list-item",
          contentClassName,
        )}
