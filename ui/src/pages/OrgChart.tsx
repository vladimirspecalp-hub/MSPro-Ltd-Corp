...
export function OrgChart() {
  ...
  useEffect(() => {
    setBreadcrumbs([{ label: t("org_chart.breadcrumb") }]);
  }, [setBreadcrumbs, t]);
  ...
  if (orgTree && orgTree.length === 0) {
    return <EmptyState icon={Network} message={t("org_chart.no_hierarchy")} />;
  }
    ...
    <div className="mb-2 flex items-center justify-start gap-2 shrink-0">
      <Link to="/company/import">
        <Button variant="outline" size="sm">
          ...
          {t("org_chart.import_company")}
        </Button>
      </Link>
      <Link to="/company/export">
        <Button variant="outline" size="sm">
          <Download className="mr-1.5 h-3.5 w-3.5" />
          {t("org_chart.export_company")}
        </Button>
      </Link>
    </div>
    <div
    ...
    >
      ...
      <div className="absolute top-3 right-3 z-10 flex flex-col gap-1">
        ...
        <button
          ...
          aria-label={t("org_chart.fit_to_screen")}
        >
          {t("org_chart.fit_label")}
        </button>
      </div>
