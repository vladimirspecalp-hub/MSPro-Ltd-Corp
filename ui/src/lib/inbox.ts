...
export const DISMISSED_KEY = "mspro-ltd:inbox:dismissed";
export const READ_ITEMS_KEY = "mspro-ltd:inbox:read-items";
export const INBOX_LAST_TAB_KEY = "mspro-ltd:inbox:last-tab";
export const INBOX_ISSUE_COLUMNS_KEY = "mspro-ltd:inbox:issue-columns";
export const INBOX_NESTING_KEY = "mspro-ltd:inbox:nesting";
export const INBOX_GROUP_BY_KEY = "mspro-ltd:inbox:group-by";
export const INBOX_FILTER_PREFERENCES_KEY_PREFIX = "mspro-ltd:inbox:filters";
export const INBOX_COLLAPSED_GROUPS_KEY_PREFIX = "mspro-ltd:inbox:collapsed-groups";
