...
export const runTranscriptFixtureEntries: TranscriptEntry[] = [
  {
    ...
    text: "[mspro-ltd] Skipping saved session resume for task \"PAP-473\" because wake reason is issue_assigned.",
  },
  {
    kind: "init",
  ...
  },
  {
    ...
    text: "I’m starting with the MSProLtd heartbeat procedure and the repo-required docs so I can see what task is actually assigned and then work only on that scope.",
  },
  {
    kind: "tool_call",
