 ...
 */
import type { CompanyPortabilityManifest } from "@msproltd/shared";
...
export function generateReadme(
  ...
  lines.push("");
  lines.push("> This is an [Agent Company](https://agentcompanies.io) package from [MSProLtd](https://mspro-ltd.ing)");
  lines.push("");
