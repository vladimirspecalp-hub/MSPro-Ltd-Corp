...
describe("shouldTrackDevServerPath", () => {
  it("ignores repo-local MSProLtd state and common test file paths", () => {
    expect(
      shouldTrackDevServerPath(
        ".mspro-ltd/worktrees/PAP-712-for-project-configuration-get-rid-of-the-overview-tab-for-now/.agents/skills/mspro-ltd",
      ),
    ).toBe(false);
