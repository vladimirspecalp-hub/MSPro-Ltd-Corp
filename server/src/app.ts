...
import { createHostClientHandlers } from "@msproltd/plugin-sdk";
...
export async function createApp(
  ...
  app.get("/api/auth/get-session", (req, res) => {
    ...
    res.json({
      session: {
        id: `mspro-ltd:${req.actor.source}:${req.actor.userId}`,
  ...
  api.use("/companies", ceoRoutes(db));
  ...
  if (opts.uiMode === "static") {
    ...
    if (uiDist) {
      ...
      console.warn("[mspro-ltd] UI dist not found; running in API-only mode");
    }
  }
