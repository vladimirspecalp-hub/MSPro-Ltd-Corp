...
- Running a Python script that calls the MSProLtd API
...
1. MSProLtd spawns the configured command as a child process
2. Standard MSProLtd environment variables are injected (`MSPROLTD_AGENT_ID`, `MSPROLTD_API_KEY`, etc.)
...
The script can use the injected environment variables to authenticate with the MSProLtd API and perform work.
