...
Manage companies within your MSProLtd instance.
...
Company logo uploads use the normal MSProLtd attachment size limit.
...
| `logoUrl` | string | Optional MSProLtd asset content path for the stored logo image |
